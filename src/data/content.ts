...
export const websiteContent = {
    ...
    values: [
      {
        ...
        description:
          "Excellence is our standard, from consultation to the final, flawless finish.",
      },
      {
        title: "Impeccable Hygiene",
        description:
          "Your safety is non-negotiable. We proudly use autoclaved tools and single-use items.",
      },
      {
        title: "Customer Satisfaction",
        description:
          "We're not happy until you're delighted. We listen, consult, and tailor every service to you.",
      },
      {
        title: "True Relaxation",
        description:
          "Your comfort is our craft. We've created a serene environment for you to disconnect and recharge.",
      },
      {
        title: "Boundless Creativity",
        description:
          "Your vision is our inspiration. We are passionate about the art of nail design.",
      },
    ],
  },
  ...
  servicesSection: {
    ...
    subtitle:
      "Premium, tailored treatments designed for your beauty, wellness, and relaxation.",
    description:
      "From meticulous manicures and pedicures to stunning custom nail art and deeply relaxing spa treatments, we offer a comprehensive menu to pamper you from head to toe.",
  ...
  gallery: {
    ...
    subtitle:
      "A showcase of our artistry, from elegant classics to bold, custom nail designs.",
    description:
      "Browse our gallery to see examples of our beautiful nail art, perfect manicures, relaxing pedicures, and stunning nail transformations created by Calgary's go-to custom nail design specialists.",
  ...
  faq: {
    ...
    description:
      "Find answers to common questions about our services, policies, and procedures. Can't find what you're looking for? Contact us directly.",
    categories: {
      general: "General",
      services: "Services",
  ...
  contact: {
    ...
    formDisclaimer:
      "Please allow up to 24 hours for a response. For immediate booking, please click the 'Book an Appointment' button.",
  },
  ...
  booking: {
    ...
    description:
      "Ready to treat yourself? Book your appointment online for convenience or call us to speak with our team directly. Please allow up to 24 hours for a response. For immediate booking, please click the 'Book an Appointment' button.",
  ...
  footer: {
    tagline:
      "Your downtown Calgary oasis for exceptional nail care and spa services",
    ...
    newsletter: {
      title: "Stay Updated",
      description:
        "Subscribe to our newsletter for the latest offers and nail care tips",
