...
export const testimonials: Testimonial[] = [
  ...
  {
    id: "khrystyna-hoydalo-review",
    name: "Khrystyna Hoydalo",
  ...
  {
    id: "seanesen-blades-review",
    name: "Seanesen Blades",
    service: "Multiple Services",
    rating: 5,
    review: "Usually when I go to a salon the technician never seems to be interested. Not here. The staff is so sweet and is interested about their clients. They are respectful, clean, kind, super affordable and professional. I only went there to get acrylics and ended up with manicure, pedicure and eyebrow waxing because I didn't want to leave. Thank you Victoria Park nails! You guys are amazing😊",
    date: "2023-12-18",
    verified: true
  },
  {
    id: "kelsey-popiel-review",
    name: "Kelsey Popiel",
    service: "Nail Services",
    rating: 5,
