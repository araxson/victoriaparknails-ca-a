...
export const faqs: FAQ[] = [
  // General Questions
  {
    ...
    answer: "We're located at 1411 1st Street SE, Calgary, AB T2G 2G3. We're open Monday-Friday 10:00 AM - 7:00 PM, Saturday-Sunday 10:00 AM - 5:30 PM, and Holidays 10:00 AM - 5:30 PM.",
    category: "general"
  },
  {
  ...
  },
  {
    ...
    answer: "Yes, we have free parking available in front of the salon and in the adjacent parking lot. Street parking is also available.",
    category: "general"
  },
  {
    id: "walk-ins-welcome",
    question: "Do you accept walk-ins?",
    answer: "Yes, we welcome walk-ins! However, appointments are recommended to ensure availability and minimize wait times, especially during busy periods and weekends.",
    category: "general"
  },
  ...
  // Aftercare
  {
    ...
    answer: "We recommend professional removal to avoid nail damage. If removing at home, soak nails in acetone for 10-15 minutes, gently push off softened gel, and moisturize thoroughly.",
    category: "aftercare"
  },
  {
    id: "nail-care-tips",
    question: "How can I make my manicure last longer?",
    answer: "Use cuticle oil daily, wear gloves when cleaning, avoid using nails as tools, apply hand cream regularly, and book touch-ups as needed. Proper care can extend your manicure's life significantly.",
    category: "aftercare"
  },
  {
    id: "chipped-nail-fix",
    question: "What should I do if a nail chips?",
    answer: "For small chips, contact us within 48 hours for a complimentary touch-up. For larger damage, we offer repair services. Don't try to fix it yourself as this may cause more damage.",
    category: "aftercare"
  },
  {
    id: "maintenance-schedule",
    question: "How often should I get my nails done?",
    answer: "Regular manicures every 2-3 weeks, gel manicures every 3-4 weeks, and nail extensions need fills every 2-3 weeks. We'll recommend a schedule based on your nail growth and lifestyle.",
    category: "aftercare"
  },
  ...
  // Pricing & Policies
  {
    ...
    answer: "Yes! We offer special rates for groups of 4 or more, bridal parties, and special events. Contact us to discuss group packages and pricing. Advanced booking required.",
    category: "pricing"
  },
  {
  ...
  },
  {
    ...
    answer: "Tipping is appreciated but not required. Standard rates are 15-20% for good service. Tips can be given in cash or added to your card payment.",
    category: "pricing"
  },
  {
    id: "loyalty-program",
    question: "Do you have a loyalty program?",
    answer: "Yes! Ask about our loyalty program where you can earn points with each visit and redeem them for discounts on future services. It's our way of thanking our regular clients.",
    category: "pricing"
  }
];
