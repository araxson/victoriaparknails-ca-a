    ...
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          ...
          "dark:border-border/70 dark:bg-card/95",
          className
        )}
        {...props}
      />
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        "dark:data-[variant=destructive]:focus:bg-destructive/30",
        ...
        "dark:focus:bg-accent/70 dark:hover:bg-accent/60",
        "dark:focus:text-accent-foreground/100 dark:hover:text-accent-foreground/95",
        className
      )}
      {...props}
    />
