...
export function FAQSection() {
  ...
  return (
    <Section className="bg-muted/30">      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16 md:mb-20">          <AnimatedDetail>
          ...
          >
            {categories.map(category => (
              <div key={category}>                <AnimatedDetail>
                    ...
                    {faqs
                      ...
                      .map(faq => (
                        <AccordionItem
                          value={faq.id}
                          key={faq.id}
                          className="rounded-lg bg-card transition-opacity hover:opacity-80"
                        >
