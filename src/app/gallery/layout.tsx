...
export const metadata: Metadata = {
  ...
  description: "Browse our gallery of beautiful nail designs, custom nail art, and salon photos. See examples of our work at Victoria Park Nails and Spa in Calgary.",
  keywords: [
    "nail art gallery",
  ...
  openGraph: {
    ...
    description: "Browse our collection of beautiful nail designs and salon photos from Calgary's premier nail salon.",
