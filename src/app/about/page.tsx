...
export const metadata: Metadata = {
  title: "Our Story & Mission | Victoria Park Nails and Spa | Calgary's Trusted Nail Salon Since 2015",
  description: "Discover the story behind Calgary's premier nail salon. Founded in 2015, Victoria Park Nails and Spa has been providing exceptional nail care, custom art, and spa services in downtown Calgary. Learn about our commitment to quality, hygiene, creativity, and customer satisfaction.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Discover the story behind Calgary's premier nail salon. Founded in 2015, learn about our commitment to quality, hygiene, creativity, and exceptional customer care.",
